...
export const siteConfig = {
  ...
  coaches: [
    {
      slug: "adrian-blanco",
      name: "Adrian Blanco Antelo",
      nameAr: "أدريان بلانكو",
      image: "/coaches/adrian-blanco.jpg",
      experience: "12+ سنة لعب",
      certifications: ["WPT Player", "FIP Certified", "Top 60 WPT"],
      specialties: ["المستوى المتقدم", "التحضير للبطولات", "التكتيك التنافسي"],
      bio: "تدرب مع نخبة اللاعبين مثل Arturo Coello وSanyo Gutiérrez وMaxi Sánchez. وصيف إسبانيا 2014، بطل غاليسيا 2018-2021، وأفضل تصنيف 36 في World Padel Tour.",
      languages: ["Spanish", "English"],
    },
    {
      slug: "antonio-manas",
      name: "Antonio Mañas Capel",
      nameAr: "أنطونيو ماياس",
      image: "/coaches/antonio-manas.jpg",
      experience: "15 سنة لعب · 9 سنوات تدريب",
      certifications: ["Spanish Padel Coach", "Andalucía Champion 2023"],
      specialties: ["تطوير الشباب", "التقنية والتكتيك", "جميع المستويات"],
      bio: "مدرب ولاعب إسباني — بطل أندلسيا للفرق 2023 وبطل ألميريا 2023. متخصص في تطوير اللاعبين الصغار والجلسات العائلية في Padel Rush.",
      languages: ["Spanish", "English"],
    },
    {
      slug: "abdullah-albasiri",
      name: "Abdullah Albasiri",
      nameAr: "عبدالله البصيري",
      image: "/coaches/abdullah-albasiri.jpg",
      experience: "10+ سنوات · مدرب وطني",
      certifications: ["Saudi Padel Committee", "Padel Rush Head Coach"],
      specialties: ["تدريب فردي", "جميع المستويات", "اللاعبين المحليين"],
      bio: "مدرب وطني في الاتحاد السعودي للبادل ومدرب رئيسي في Padel Rush — خبرة في تأسيس الأكاديميات وتطوير لاعبي البادل في الرياض.",
      languages: ["Arabic", "English"],
    },
    {
      slug: "lourdes-garcia",
      name: "Lourdes García (Lou)",
      nameAr: "لورديس غارسيا",
      image: "/coaches/lourdes-garcia.jpg",
      experience: "10+ سنوات لعب · 4 سنوات تدريب",
      certifications: ["Andalusian Padel Federation", "Ranking #2 Almería"],
      specialties: ["تدريب السيدات", "Women Exclusive Day", "المستوى المتوسط والمتقدم"],
      bio: "لاعبة ومدربة إسبانية — المركز الثاني في تصنيف ألميريا. متخصصة في تدريب السيدات بخبرة تنافسية واسعة.",
