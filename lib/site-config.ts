  ...
  coaches: [
    {
      ...
      image: "/coaches/adrian-blanco.png",
    ...
    },
    {
      ...
      name: "Antonio",
      nameAr: "أنطونيو",
      image: "/coaches/antonio.png",
      experience: "15 سنة لعب · 5 سنوات تدريب",
      certifications: ["Spanish Padel Coach", "Andalucía Champion 2023"],
      specialties: ["التقنية والتكتيك", "التحضير للمنافسة", "جميع المستويات"],
      bio: "مدرب ولاعب إسباني — بطل أندلسيا للفرق 2023 وبطل ألميريا 2023. تلميذ Marcel Fernández مدرب Paquito Navarro.",
      languages: ["Spanish", "English"],
    },
    {
      ...
      image: "/coaches/abdullah-albasiri.png",
      experience: "مدرب معتمد",
      certifications: ["Padel Rush Coach"],
      specialties: ["تدريب فردي", "جميع المستويات", "اللاعبين المحليين"],
      bio: "مدربنا الجديد في Padel Rush — يجمع بين الخبرة المحلية والشغف بتطوير لاعبي البادل في الرياض.",
    ...
    },
    {
      ...
      image: "/coaches/lourdes-garcia.png",
