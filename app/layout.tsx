...
export const metadata: Metadata = {
  ...
  description: `Padel Rush · DON'T MISS OUT ON AN EXPERIENCE. 9 ملاعب بادل داخلية وخارجية في Boulevard Riyadh City. احجز عبر Playtomic. King of the Court، Women Day، أكاديمية، ومتجر.`,
  icons: {
    icon: "/favicon.ico",
    apple: "/favicon.ico",
  },
